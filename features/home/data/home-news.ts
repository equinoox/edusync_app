...
export const homeNewsArticles: HomeNewsArticle[] = [
  ...
  {
    id: 7,
    title: "Build real success with EduSync",
    description: "Stay organized, study smarter, and turn daily progress into better results.",
    image: "/news/news_img_7.jpg",
    body: "Success with EduSync starts by keeping everything you need in one focused place. Upload your materials, organize subjects, use the AI assistant when you get stuck, and track your progress over time. Instead of jumping between notes, quizzes, and reminders, EduSync helps you build a clearer study routine and make every session more productive.",
  },
  {
    id: 8,
